...
public class MyIntervalView extends LinearLayout {
    ...
    public MyIntervalView(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public MyIntervalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    ...
    public MyIntervalView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyIntervalView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        activity_inter_val = (LinearLayout) findViewById(R.id.activity_inter_val);
    ...
    public void setDatas(List<Integer> intervals, int position) {
        ...
        int lineWidth = ((screenWidth - circleImgWidth * intervals.size()) / (intervals.size() - 1))+circleImgWidth;//加上了圆形的宽度
